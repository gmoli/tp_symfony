...
use TP\UserBundle\Entity\User;
use TP\UserBundle\Form\UserType;
...
class UserController extends Controller
{
    ...
    */
    ...
    public function updateAction(Request $request, $id)
    {
        ...
        if (!$entity) {
            throw $this->createNotFoundException('No se encuentra usuario');
        }
    ...
    private function setSecurePassword(&$entity) {
       ...
       $encoder = new \Symfony\Component\Security\Core\Encoder\MessageDigestPasswordEncoder('sha1', true, 10);
