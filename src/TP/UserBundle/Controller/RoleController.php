...
use TP\UserBundle\Entity\Role;
use TP\UserBundle\Form\RoleType;
...
class RoleController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('TPUserBundle:Role')->findAll();
     ...
     * @Method("POST")
     * @Template("TPUserBundle:Role:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('TPUserBundle:Role')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("TPUserBundle:Role:edit.html.twig")
     */
